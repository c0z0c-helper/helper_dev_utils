...
class TestGetLogger:
    ...
    def test_file_logging(self, temp_dir):
        logger = get_logger("test_file", file=True, log_dir=temp_dir)
    ...
    def test_file_logging_path_layout(self, temp_dir):
        logger = get_logger("test_file_layout", file=True, log_dir=temp_dir)
        log_file = _find_log_file(temp_dir)
    ...
    def test_file_logging_shared_across_loggers(self, temp_dir):
        logger1 = get_logger("test_shared1", file=True, log_dir=temp_dir)
        logger2 = get_logger("test_shared2", file=True, log_dir=temp_dir)
...
class TestGetAutoLogger:
    ...
    def test_auto_logger_with_kwargs(self, temp_dir):
        logger = get_auto_logger(file=True, log_dir=temp_dir)
...
class TestIntegration:
    ...
    def test_logger_level_filtering(self, temp_dir):
        logger = get_logger("test_filter", level=logging.WARNING, file=True, log_dir=temp_dir)
    ...
    def test_reconfiguring_logger_does_not_duplicate_output(self, temp_dir, capsys):
        get_logger("test_reconf", file=True, log_dir=temp_dir)
        logger = get_logger("test_reconf", file=True, log_dir=temp_dir)
